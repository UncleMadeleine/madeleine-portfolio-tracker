...
def take_snapshot(
    portfolio: dict, prefer_akshare: bool = False
    ...
    return base, view, summarize(view), all_issues


def main(argv=None) -> None:
    ap = argparse.ArgumentParser(description="投资组合命令行快照")
    ...
    base, view, summary, issues = take_snapshot(
        portfolio, prefer_akshare=args.akshare
    )
